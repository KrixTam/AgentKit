...
class SimpleRAGAgent:
    """轻量 RAG 构建器：本地文档检索 + 默认文件记忆 + 标准 Agent 输出。"""
    ...
    def __init__(
        ...
        *,
        ...
        memory_file: str = ".agentkit/rag_memory.json",
    ) -> None:
        self.model = model
        ...
        self.memory: BaseMemoryProvider = memory_provider or FileMemoryProvider(memory_file)
        self.reload()
